...
class BulletinsDataSourceTest: XCTestCase {
    ...
    func testHeaderDateLabelText() {
        ...
        self.dataSource!.referenceDate = Date(timeIntervalSince1970: 1441609200)
        ...
        self.dataSource!.referenceDate = Date(timeIntervalSince1970: 1441436400)
        ...
        self.dataSource!.referenceDate = Date(timeIntervalSince1970: 1441522800)
        ...
        // Sunday, September 13 2015
        self.dataSource!.referenceDate = Date(timeIntervalSince1970: 1442127900)
        ...
        self.dataSource!.referenceDate = Date(timeIntervalSince1970: 1441695600)
